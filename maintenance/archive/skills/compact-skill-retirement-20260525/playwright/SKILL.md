...
$env:PWCLI = "$env:CODEX_HOME\skills\playwright\scripts\playwright_cli.cmd"
```
...
Use the wrapper script. On Windows PowerShell:

```powershell
& $env:PWCLI open https://playwright.dev --headed
& $env:PWCLI snapshot
& $env:PWCLI click e15
& $env:PWCLI type "Playwright"
& $env:PWCLI press Enter
