...
- **Stack**: infer from the project or user request. Supported stacks include React, Next.js, shadcn/ui, Vue, Nuxt.js, Nuxt UI, Svelte, Astro, Angular, Laravel, HTML+Tailwind, SwiftUI, React Native, Flutter, Jetpack Compose, and Three.js.
...
Get implementation-specific best practices for the current stack:
...
| Stack | Focus |
|-------|-------|
| `react` | Components, hooks, performance, state, accessibility |
| `nextjs` | App Router, SSR/SSG, image/font performance |
| `shadcn` | shadcn/ui patterns, tokens, component composition |
| `vue` | Vue components, reactivity, composition patterns |
| `nuxtjs` | Nuxt routing, SSR, layouts, data fetching |
| `nuxt-ui` | Nuxt UI components and theming |
| `svelte` | Svelte components, transitions, stores |
| `astro` | Content-first pages, islands, performance |
| `angular` | Angular components, forms, Material patterns |
| `laravel` | Blade, Livewire, Inertia UI patterns |
| `html-tailwind` | HTML and Tailwind implementation guidelines |
| `swiftui` | iOS SwiftUI layout, navigation, accessibility |
| `react-native` | Components, Navigation, Lists |
| `flutter` | Flutter widgets, Material/Cupertino, responsive layout |
| `jetpack-compose` | Android Compose layout, state, Material |
| `threejs` | 3D scenes, performance, interaction |
...
- Stack: infer from the project or request
...
- Add `--stack <stack>` when implementation-specific guidance matters, for example `--stack react`, `--stack nextjs`, `--stack html-tailwind`, or `--stack react-native`
